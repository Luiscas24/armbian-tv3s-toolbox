...
*   [ ] **Fase 1: Motor del Sistema (Kernel & Conectividad):** Compilación automatizada en la nube de un Kernel moderno (6.x Edge) con drivers críticos Realtek integrados.
